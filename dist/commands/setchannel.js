...
exports.setChannelCommand = {
    ...
    handler: async (bot, msg, match) => {
        ...
        if (!rawParam) {
            ...
            }[lang] || "⚠️ Please specify target channel: <code>/setchannel @channel</code>";
        ...
        if (!rawParam.startsWith('@') && !rawParam.startsWith('-100')) {
            ...
            }[lang] || "❌ Invalid format. Use @channel or -100xxx ID.";
        ...
        try {
            ...
            if (member.status === 'administrator' || member.status === 'creator') {
                ...
                }[lang] || `✅ Target channel successfully set to ${rawParam}`;
                ...
                }[lang] || "❌ Bot is not an administrator in this channel.";
            ...
            }[lang] || `❌ Channel verification failed: ${e.message}`;
